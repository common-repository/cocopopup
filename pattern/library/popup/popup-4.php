...
register_block_pattern(
    'cocopopup/popup-4',
    array(
        'title'         => __( 'Popup 4', 'cocopopup' ),
        'description'   => __( 'Popup Verification', 'cocopopup' ),
        'content'       => trim($content),
        'categories'    => array( 'popup' ),
        'keywords'      => array( 'popup', 'form', 'verification'),
        'viewportWidth' => 800,
    )
);